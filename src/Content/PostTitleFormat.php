...
/**
 * Filters the title format strings used for protected and private posts.
 */
final class PostTitleFormat implements Bootable
{
	/**
	 * @inheritDoc
	 */
	...
	/**
	 * Appends the post state to protected post titles.
	 */
	...
	/**
	 * Appends the post state to private post titles.
	 */
