...
$sketch     = get_theme_file_uri('public/media/images/template/arc-sketch.webp');
?>
	...
	<div class="wp-block-columns home-grid">
		...
		<div class="wp-block-column" style="flex-basis:38%">
			...
			<header class="wp-block-group">
				...
				<figure class="wp-block-image size-large is-style-image-sketch"><img src="<?= esc_url($sketch) ?>" alt="AI_IMAGE: A quick, expressive pencil and sepia wash sketch of a distant mountain ridge line with sparse pine trees, drawn loosely on a textured journal page | illustration | landscape"/><figcaption class="wp-element-caption">Everything connects if you follow it long enough.</figcaption></figure>
				<!-- /wp:image -->
