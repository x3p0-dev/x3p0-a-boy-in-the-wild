...
$sketch     = get_theme_file_uri('public/media/images/template/era-sketch.webp');
?>
	...
	<div class="wp-block-columns home-grid">
		...
		<div class="wp-block-column" style="flex-basis:38%">
			...
			<header class="wp-block-group">
				...
				<!-- wp:site-title {"metadata":{"name":"<?= esc_attr__('The Title', 'x3p0-a-boy-in-the-wild') ?>"}} /-->
				...
				<div class="wp-block-group">
					...
					<p class="is-style-text-kicker"><?= esc_html__('Era', 'x3p0-a-boy-in-the-wild') ?></p>
					<!-- /wp:paragraph -->
				...
				<figure class="wp-block-image size-large is-style-image-sketch"><img src="<?= esc_url($sketch) ?>" alt=""/><figcaption class="wp-element-caption"><?= esc_html__('The territory as I know it. Corrections pending.', 'x3p0-a-boy-in-the-wild') ?></figcaption></figure>
				<!-- /wp:image -->
			...
			<main class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group is-style-container-meta">
						...
						<!-- wp:icon {"icon":"x3p0/sun-path","style":{"dimensions":{"width":"40px"}}} /-->
