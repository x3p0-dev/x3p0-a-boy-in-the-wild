...
use X3P0\ABoyInTheWild\Block\Binding\Sources\Term;
	...
	<div class="wp-block-columns home-grid">
		...
		<div class="wp-block-column" style="flex-basis:38%">
			...
			<header class="wp-block-group">
				...
				<figure class="wp-block-image size-large is-style-image-sketch"><img src="<?= esc_url(Image::TemplateEraSketch->url()) ?>" alt=""/><figcaption class="wp-element-caption"><?= esc_html__('The territory as I know it. Corrections pending.', 'x3p0-a-boy-in-the-wild') ?></figcaption></figure>
				<!-- /wp:image -->
			...
			<main class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group is-style-container-meta">
						...
						<!-- wp:paragraph {"metadata":{"bindings":{"content":{"source":"<?= esc_attr(Term::NAME) ?>","args":{"field":"count"}}}},"className":"is-style-text-kicker"} -->
