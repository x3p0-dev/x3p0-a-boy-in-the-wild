...
/**
 * Title: Author Archive Template
 * Slug: x3p0-a-boy-in-the-wild/template-author
 * Inserter: no
 */
		...
		<div class="wp-block-column" style="flex-basis:38%">
			...
			<header class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<p class="is-style-text-kicker"><?= esc_html__('Narrator', 'x3p0-a-boy-in-the-wild' ) ?></p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:post-author-biography {"className":"is-style-text-caption"} /-->

				</div>
				<!-- /wp:group -->

				<!-- wp:image {"metadata":{"name":"The Sketch"},"sizeSlug":"large","className":"is-style-image-sketch"} -->
				<figure class="wp-block-image size-large is-style-image-sketch"><img src="<?= esc_url($sketch) ?>" alt="AI_IMAGE: A quick, expressive pencil and sepia wash sketch of a distant mountain ridge line with sparse pine trees, drawn loosely on a textured journal page | illustration | landscape"/><figcaption class="wp-element-caption">Written by hand. All of it.</figcaption></figure>
				<!-- /wp:image -->
			...
			<main class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<div class="wp-block-group is-style-container-meta">
						...
						<!-- wp:icon {"icon":"x3p0/draw","style":{"dimensions":{"width":"40px"}}} /-->
