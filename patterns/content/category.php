 ...
 * Slug: x3p0-a-boy-in-the-wild/content-category
 * Inserter: no
 */
	...
	<div class="wp-block-columns home-grid">
		...
		<div class="wp-block-column" style="flex-basis:38%">
			...
			<header class="wp-block-group">
				...
				<figure class="wp-block-image size-large is-style-chapter-field-sketch"><img src="<?= esc_url($sketch) ?>" alt="AI_IMAGE: A quick, expressive pencil and sepia wash sketch of a distant mountain ridge line with sparse pine trees, drawn loosely on a textured journal page | illustration | landscape"/><figcaption class="wp-element-caption">The territory as I know it. Corrections pending.</figcaption></figure>
				<!-- /wp:image -->
